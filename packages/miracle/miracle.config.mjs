    ...
    locales: {
      'zh-CN': {
        ...
        nav: [
          ...
          //     { path: 'date-picker', title: 'DatePicker 日期选择' },
          ...
          //     { path: 'picker-group', title: 'PickerGroup 选择器组' },
          ...
          //     { path: 'time-picker', title: 'TimePicker 时间选择' },
        ...
        nav: [
          {
            ...
            items: [
              ...
              // { path: 'release-note-v4', title: '4.0 Release Note' },
              // { path: 'migrate-from-v2', title: 'Upgrade from v2 to v3' },
              // { path: 'migrate-from-v3', title: 'Upgrade from v3 to v4' },
              // { path: 'contribution', title: 'Contribution Guide' },
              // { path: 'design', title: 'Design Resources' },
              // { path: 'locale', title: 'Internationalization' },
            ],
          },
          {
            ...
            items: [
              ...
              // { path: 'cell', title: 'Cell' },
              // { path: 'config-provider', title: 'ConfigProvider' },
              { path: 'icon', title: 'Icon' },
              // { path: 'image', title: 'Image' },
              // { path: 'col', title: 'Layout' },
              // { path: 'popup', title: 'Popup' },
              // { path: 'space', title: 'Space' },
              // { path: 'style', title: 'Built-in style' },
          ...
          //   items: [
          //     { path: 'action-sheet', title: 'ActionSheet' },
          //     { path: 'barrage', title: 'Barrage' },
          //     { path: 'dialog', title: 'Dialog' },
          //     { path: 'dropdown-menu', title: 'DropdownMenu' },
          //     { path: 'floating-panel', title: 'FloatingPanel' },
          //     { path: 'floating-bubble', title: 'FloatingBubble' },
          //     { path: 'loading', title: 'Loading' },
          //     { path: 'notify', title: 'Notify' },
          //     { path: 'overlay', title: 'Overlay' },
          //     { path: 'pull-refresh', title: 'PullRefresh' },
          //     { path: 'share-sheet', title: 'ShareSheet' },
          //     { path: 'swipe-cell', title: 'SwipeCell' },
          //   ],
          // },
          {
            ...
            items: [
              ...
              // { path: 'circle', title: 'Circle' },
              // { path: 'collapse', title: 'Collapse' },
              // { path: 'count-down', title: 'CountDown' },
              // { path: 'divider', title: 'Divider' },
              // { path: 'empty', title: 'Empty' },
              // { path: 'highlight', title: 'Highlight' },
              // { path: 'image-preview', title: 'ImagePreview' },
              // { path: 'lazyload', title: 'Lazyload' },
              // { path: 'list', title: 'List' },
              // { path: 'notice-bar', title: 'NoticeBar' },
              // { path: 'popover', title: 'Popover' },
              // { path: 'progress', title: 'Progress' },
              // { path: 'rolling-text', title: 'RollingText' },
              // { path: 'skeleton', title: 'Skeleton' },
              // { path: 'steps', title: 'Steps' },
              // { path: 'sticky', title: 'Sticky' },
              // { path: 'swipe', title: 'Swipe' },
              // { path: 'tag', title: 'Tag' },
              // { path: 'text-ellipsis', title: 'TextEllipsis' },
          ...
          //   items: [
          //     { path: 'action-bar', title: 'ActionBar' },
          //     { path: 'back-top', title: 'BackTop' },
          //     { path: 'grid', title: 'Grid' },
          //     { path: 'index-bar', title: 'IndexBar' },
          //     { path: 'nav-bar', title: 'NavBar' },
          //     { path: 'pagination', title: 'Pagination' },
          //     { path: 'sidebar', title: 'Sidebar' },
          //     { path: 'tab', title: 'Tab' },
          //     { path: 'tabbar', title: 'Tabbar' },
          ...
          //   items: [
          //     { path: 'address-edit', title: 'AddressEdit' },
          //     { path: 'address-list', title: 'AddressList' },
          //     { path: 'area', title: 'Area' },
          //     { path: 'card', title: 'Card' },
          //     { path: 'contact-card', title: 'ContactCard' },
          //     { path: 'contact-edit', title: 'ContactEdit' },
          //     { path: 'contact-list', title: 'ContactList' },
          //     { path: 'coupon-list', title: 'Coupon' },
          //     { path: 'submit-bar', title: 'SubmitBar' },
          //   ],
          // },
          // {
          //   title: 'Composables',
          //   items: [
          //     { path: 'miracle-use-intro', title: 'Intro' },
          //     { path: 'use-click-away', title: 'useClickAway' },
          //     { path: 'use-count-down', title: 'useCountDown' },
          //     { path: 'use-custom-field-value', title: 'useCustomFieldValue' },
          //     { path: 'use-event-listener', title: 'useEventListener' },
