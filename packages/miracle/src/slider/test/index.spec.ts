...
test('should emit "update:modelValue" event after dragging button', () => {
  ...
  const button = wrapper.find('.mi-slider__button');
...
// https://github.com/wuxingxi888/miracle/issues/8889
...
test('should render button slot correctly', async () => {
  ...
  const button = wrapper.find('.mi-slider__button-wrapper');
