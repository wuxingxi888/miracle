...
<template>
  <demo-block :title="t('textWatermark')">
    <div class="demo-watermark-wrapper">
      <mi-watermark content="Miracle" :full-page="false" />
    </div>
  </demo-block>
  ...
  <demo-block :title="t('displayRange')">
    <div class="demo-watermark-wrapper">
      <mi-button type="primary" @click="fullPage = !fullPage">
        {{ t('switch') }}
      </mi-button>
      <mi-watermark
        :full-page="fullPage"
  ...
  <demo-block :title="t('htmlWatermark')">
    <div class="demo-watermark-wrapper">
      <mi-watermark :width="150" :full-page="false">
        <template #content>
          <div
            style="
