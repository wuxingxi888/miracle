...
import { showDialog, showConfirmDialog, Dialog as MiDialog } from '..';
import { ref } from 'vue';
...
<template>
  <demo-block card :title="t('basicUsage')">
    <mi-cell is-link :title="t('alert1')" @click="onClickAlert" />
    <mi-cell is-link :title="t('alert2')" @click="onClickAlert2" />
    <mi-cell is-link :title="t('confirm')" @click="onClickConfirm" />
  </demo-block>

  <demo-block card :title="t('roundButton')">
    <mi-cell is-link :title="t('alert1')" @click="onClickRound" />
    <mi-cell is-link :title="t('alert2')" @click="onClickRound2" />
  </demo-block>

  <demo-block card :title="t('beforeClose')">
    <mi-cell is-link :title="t('beforeClose')" @click="onClickBeforeClose" />
  </demo-block>
