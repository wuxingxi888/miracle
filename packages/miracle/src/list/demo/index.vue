  ...
  <mi-tabs>
    <mi-tab :title="t('basicUsage')">
      <mi-list
        ...
        @load="onLoad(0)"
      >
        <mi-cell v-for="item in list[0].items" :key="item" :title="item" />
      </mi-list>
    </mi-tab>
    ...
    <mi-tab :title="t('errorInfo')">
      <mi-list
        ...
        @load="onLoad(1)"
      >
        <mi-cell v-for="item in list[1].items" :key="item" :title="item" />
      </mi-list>
    </mi-tab>

    <mi-tab :title="t('pullRefresh')">
      <mi-pull-refresh v-model="list[2].refreshing" @refresh="onRefresh(2)">
        <mi-list
          ...
          @load="onLoad(2)"
        >
          <mi-cell v-for="item in list[2].items" :key="item" :title="item" />
        </mi-list>
      </mi-pull-refresh>
    </mi-tab>
  </mi-tabs>
