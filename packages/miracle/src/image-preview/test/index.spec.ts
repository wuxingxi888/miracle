...
test('should swipe to current index after calling the swipeTo method', async () => {
  ...
  await later(100);
  expect(wrapper.find('.mi-image-preview__index').html()).toMatchSnapshot();
});
...
test('should allow to use the teleport prop', () => {
  ...
  expect(root.querySelector('.mi-image-preview')).toBeTruthy();
});
...
test('should render close icon when using closeable prop', () => {
  ...
  wrapper.find('.mi-image-preview__close-icon').trigger('click');
...
test('should change close icon when using close-icon prop', () => {
  ...
  expect(
    wrapper.find('.mi-image-preview__close-icon').html(),
  ).toMatchSnapshot();
});
...
test('should hide index when show-index prop is false', async () => {
  ...
  expect(wrapper.find('.mi-image-preview__index').exists()).toBeTruthy();

  await wrapper.setProps({ showIndex: false });
  expect(wrapper.find('.mi-image-preview__index').exists()).toBeFalsy();
});
...
test('render image', async () => {
  ...
  const swipe = wrapper.find('.mi-swipe-item');
...
test('before close prop', async () => {
  ...
  const swipe = wrapper.find('.mi-swipe__track');
...
test('should close when image is clicked', async () => {
  ...
  await later();
  const image = wrapper.find('.mi-image');
...
test('zoom in and drag image to move', async () => {
  ...
  expect(wrapper.find('.mi-image').html()).toMatchSnapshot();
