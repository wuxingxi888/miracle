...
Vant officially provides a default china area data, which can be imported through [@miracle/area-data](https://github.com/wuxingxi888/miracle/tree/main/packages/miracle-area-data):
