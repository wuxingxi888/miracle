...
import MiShareSheet, { ShareSheetOption, ShareSheetOptions } from '..';
...
<template>
  <demo-block card :title="t('basicUsage')">
    <mi-cell is-link :title="t('showSheet')" @click="showBasic = true" />
    <mi-share-sheet
  ...
  <demo-block card :title="t('multiLine')">
    <mi-cell is-link :title="t('showSheet')" @click="showMultiLine = true" />
    <mi-share-sheet
  ...
  <demo-block card :title="t('customIcon')">
    <mi-cell is-link :title="t('showSheet')" @click="showCustomIcon = true" />
    <mi-share-sheet
  ...
  <demo-block card :title="t('withDesc')">
    <mi-cell is-link :title="t('showSheet')" @click="showWithDesc = true" />
    <mi-share-sheet
