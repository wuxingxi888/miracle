...
export default defineComponent({
    ...
    setup(props, { emit, slots }) {
        ...
        const isMinYear = (year: number) =>
            year === props.minDate.getFullYear();
        const isMaxYear = (year: number) =>
            year === props.maxDate.getFullYear();
        ...
        const genDayOptions = () => {
            ...
            const minDate =
                isMinYear(year) && isMinMonth(month)
                ...
                switch (type) {
                    ...
                    default:
                        if (process.env.NODE_ENV !== 'production') {
                            throw new Error(
                                `[Miracle] DatePicker: unsupported columns type: ${type}`,
                            );
                        }
                        return [];
                }
