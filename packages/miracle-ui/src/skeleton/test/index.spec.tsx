...
test('should change avatar size when using avatar-size prop', () => {
    ...
    const avatar = wrapper.find('.mi-skeleton-avatar');
...
test('should change avatar shape when using avatar-shape prop', () => {
    ...
    expect(wrapper.find('.mi-skeleton-avatar').html()).toMatchSnapshot();
});
...
test('should be round when using round prop', () => {
    ...
    expect(wrapper.find('.mi-skeleton--round').exists()).toBeTruthy();
});
...
test('should allow to disable animation', async () => {
    ...
    expect(wrapper.find('.mi-skeleton--animate').exists()).toBeTruthy();

    await wrapper.setProps({ animate: false });
    expect(wrapper.find('.mi-skeleton--animate').exists()).toBeFalsy();
});
