...
test('show-title prop', async () => {
    ...
    expect(wrapper.find('.mi-calendar__header-title').exists()).toBeTruthy();
    await wrapper.setProps({ showTitle: false });
    expect(wrapper.find('.mi-calendar__header-title').exists()).toBeFalsy();
});
...
test('show-subtitle prop', async () => {
    ...
    expect(wrapper.find('.mi-calendar__header-subtitle').exists()).toBeTruthy();
    await wrapper.setProps({ showSubtitle: false });
    expect(wrapper.find('.mi-calendar__header-subtitle').exists()).toBeFalsy();
});
...
test('hide close icon when there is no title', async () => {
    ...
    expect(wrapper.find('.mi-popup__close-icon').exists()).toBeTruthy();

    await wrapper.setProps({
        showTitle: false,
        showSubtitle: false,
    });
    expect(wrapper.find('.mi-popup__close-icon').exists()).toBeFalsy();
});
...
test('first day of week', async () => {
    ...
    expect(wrapper.findAll('.mi-calendar__weekday')[0].text()).toEqual('Tue');

    const day = wrapper.find(
        '.mi-calendar__month:first-of-type .mi-calendar__day',
    );
...
test('should disabled prompt when using show-range-prompt prop', async () => {
    ...
    await later();
    expect(document.querySelector('.mi-toast')).toBeFalsy();
});
...
test('should call reset when defaultDate prop changes', async () => {
    ...
    expect(wrapper.find('.mi-calendar__confirm').classes()).toContain(
        'mi-button--disabled',
    );
