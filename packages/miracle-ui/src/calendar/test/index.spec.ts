...
test('should reset to default date when calling reset method', async () => {
    ...
    const days = wrapper.findAll('.mi-calendar__day');
    await days[15].trigger('click');
    await days[18].trigger('click');

    (wrapper.vm as CalendarInstance).reset();

    wrapper.find('.mi-calendar__confirm').trigger('click');
    expect(wrapper.emitted<[Date, Date]>('confirm')![0][0]).toEqual(
        defaultDate,
    );
});
...
test('select event when type is single', async () => {
    ...
    wrapper.findAll('.mi-calendar__day')[15].trigger('click');
...
test('should not trigger select event when click disabled day', async () => {
    ...
    wrapper.findAll('.mi-calendar__day')[1].trigger('click');
...
test('should trigger click-disabled-date event when click disabled day', async () => {
    ...
    const disabeldDate = wrapper.findAll('.mi-calendar__day--disabled')[0];
...
test('row-height prop', async () => {
    ...
    expect(wrapper.find('.mi-calendar__day').style.height).toEqual('50px');
});
...
test('should render subtitle slot with params', async () => {
    ...
    expect(
        wrapper.find('.mi-calendar__header-subtitle').html(),
    ).toMatchSnapshot();
});
...
test('should render month-title slot correctly', async () => {
    ...
    expect(wrapper.find('.mi-calendar__month-title').html()).toMatchSnapshot();
});
...
test('popup wrapper', async () => {
    ...
    await wrapper.find('.mi-popup__close-icon').trigger('click');
    expect(wrapper.find('.mi-calendar__popup').style.display).toEqual('none');
});
...
test('set show-mark prop to false', async () => {
    ...
    expect(wrapper.find('.mi-calendar__month-mark').exists()).toBeFalsy();
});
...
test('color prop when type is single', async () => {
    ...
    expect(wrapper.find('.mi-calendar__selected-day').style.background).toEqual(
        'blue',
    );
});
...
test('color prop when type is range', async () => {
    ...
    expect(wrapper.find('.mi-calendar__day--start').style.background).toEqual(
        'blue',
    );
    expect(wrapper.find('.mi-calendar__day--middle').style.color).toEqual(
        'blue',
    );
    expect(wrapper.find('.mi-calendar__day--end').style.background).toEqual(
        'blue',
    );
});
...
test('should render top-info and bottom-info slot correctly', async () => {
    ...
    expect(wrapper.find('.mi-calendar__day').html()).toMatchSnapshot();
});
...
test('should emit clickSubtitle event when clicking the subtitle', async () => {
    ...
    await later();
    wrapper.find('.mi-calendar__header-subtitle').trigger('click');
...
test('should render confirm-text slot correctly', async () => {
    ...
    expect(wrapper.find('.mi-calendar__confirm').html()).toMatchSnapshot();
});
