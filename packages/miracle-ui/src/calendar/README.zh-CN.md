...
| 名称 | 默认值 | 描述 |
| --- | --- | --- |
| --mi-calendar-background | _var(--mi-background-2)_ | - |
| --mi-calendar-popup-height | _80%_ | - |
| --mi-calendar-header-shadow | _0 2px 10px rgba(125, 126, 128, 0.16)_ | - |
| --mi-calendar-header-title-height | _44px_ | - |
| --mi-calendar-header-title-font-size | _var(--mi-font-size-lg)_ | - |
| --mi-calendar-header-subtitle-font-size | _var(--mi-font-size-md)_ | - |
| --mi-calendar-header-action-width | _28px_ | - |
| --mi-calendar-header-action-color | _var(--mi-text-color)_ | - |
| --mi-calendar-header-action-disabled-color | _var(--mi-text-color-3)_ | - |
| --mi-calendar-weekdays-height | _30px_ | - |
| --mi-calendar-weekdays-font-size | _var(--mi-font-size-sm)_ | - |
| --mi-calendar-month-title-font-size | _var(--mi-font-size-md)_ | - |
| --mi-calendar-month-mark-color | _fade(var(--mi-gray-2), 80%)_ | - |
| --mi-calendar-month-mark-font-size | _160px_ | - |
| --mi-calendar-day-height | _64px_ | - |
| --mi-calendar-day-font-size | _var(--mi-font-size-lg)_ | - |
| --mi-calendar-day-margin-bottom | _4px_ | - |
| --mi-calendar-day-disabled-color | _var(--mi-text-color-3)_ | - |
| --mi-calendar-range-edge-color | _var(--mi-white)_ | - |
| --mi-calendar-range-edge-background | _var(--mi-primary-color)_ | - |
| --mi-calendar-range-middle-color | _var(--mi-primary-color)_ | - |
| --mi-calendar-range-middle-background-opacity | _0.1_ | - |
| --mi-calendar-selected-day-size | _54px_ | - |
| --mi-calendar-selected-day-color | _var(--mi-white)_ | - |
| --mi-calendar-selected-day-background | _var(--mi-primary-color)_ | - |
| --mi-calendar-info-font-size | _var(--mi-font-size-xs)_ | - |
| --mi-calendar-info-line-height | _var(--mi-line-height-xs)_ | - |
| --mi-calendar-confirm-button-height | _36px_ | - |
| --mi-calendar-confirm-button-margin | _7px 0_ | - |
