    ...
    setup(props, { emit, slots }) {
        ...
        const onScroll = () => {
            ...
            if (selectActiveIndex) {
                ...
                if (match) {
                    const rect = match.getRect(
                        scrollParent.value,
                        scrollParentRect,
                    );
                    if (props.sticky && props.stickyOffsetTop) {
                        active = getActiveAnchor(
                            rect.top - props.stickyOffsetTop,
                            rects,
                        );
                    } else {
        ...
        const scrollTo = (index: Numeric) => {
            ...
            if (match) {
                ...
                if (props.sticky && props.stickyOffsetTop) {
                    if (
                        getRootScrollTop() ===
                        offsetHeight - scrollParentRect.height
                    ) {
                        setRootScrollTop(getRootScrollTop());
                    } else {
                        setRootScrollTop(
                            getRootScrollTop() - props.stickyOffsetTop,
                        );
                    }
                }
