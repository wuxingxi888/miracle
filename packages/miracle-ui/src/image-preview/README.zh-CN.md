...
为了便于使用 `ImagePreview`，Miracle 提供了一系列辅助函数，通过辅助函数可以快速唤起全局的图片预览组件。
...
Miracle 中导出了以下 ImagePreview 相关的辅助函数：
...
| 名称                                  | 默认值                       | 描述 |
| ------------------------------------- | ---------------------------- | ---- |
| --mi-image-preview-index-text-color   | _var(--mi-white)_            | -    |
| --mi-image-preview-index-font-size    | _var(--mi-font-size-md)_     | -    |
| --mi-image-preview-index-line-height  | _var(--mi-line-height-md)_   | -    |
| --mi-image-preview-index-text-shadow  | _0 1px 1px var(--mi-gray-8)_ | -    |
| --mi-image-preview-overlay-background | _rgba(0, 0, 0, 0.9)_         | -    |
| --mi-image-preview-close-icon-size    | _22px_                       | -    |
| --mi-image-preview-close-icon-color   | _var(--mi-gray-5)_           | -    |
| --mi-image-preview-close-icon-margin  | _var(--mi-padding-md)_       | -    |
| --mi-image-preview-close-icon-z-index | _1_                          | -    |
...
* miracle/es/show-image-preview in ./src/xxx.js
* miracle/es/show-image-preview/style in ./src/xxx.js
```
