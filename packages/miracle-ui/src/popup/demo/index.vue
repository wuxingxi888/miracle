...
<template>
  ...
  <demo-block card :title="t('position')">
    ...
    <mi-cell :title="t('buttonBottom')" is-link @click="showBottom = true" />
  ...
  <demo-block card :title="t('closeIcon')">
    <mi-cell :title="t('closeIcon')" is-link @click="showCloseIcon = true" />
    <mi-cell
  ...
  <demo-block card :title="t('teleport')">
    <mi-cell :title="t('teleport')" is-link @click="showGetContainer = true" />
    <mi-popup
