...
export default defineComponent({
    ...
    setup(props, { emit, attrs, slots }) {
        ...
        const renderPopup = lazyRender(() => {
            const { round, position, safeAreaInsetTop, safeAreaInsetBottom } =
                props;
            ...
            return (
                <div
                    ...
                    class={[
                        ...
                        {
                            'mi-safe-area-top': safeAreaInsetTop,
                            'mi-safe-area-bottom': safeAreaInsetBottom,
                        },
                    ]}
                    onKeydown={onKeydown}
                    {...attrs}
