...
test('should render correctly when all props set', async () => {
    ...
    expect(floatingBubbleEl.style.transform).toEqual(
        `translate3d(${window.innerWidth - 48 - 50}px, ${window.innerHeight - 48 - 50}px, 0)`,
    );
    ...
    expect(floatingBubbleEl.querySelector('.mi-icon-chat')).not.toBeNull();
...
test('should only x axis direction adn emit offsetChange move when axis is "x" ', async () => {
    ...
    expect(floatingBubbleEl.style.transform).toEqual(
        `translate3d(${window.innerWidth - 48 - 24 - 100}px, ${window.innerHeight - 48 - 24}px, 0)`,
    );
...
test('should free direction move when axis is "xy" ', async () => {
    ...
    expect(floatingBubbleEl.style.transform).toEqual(
        `translate3d(${window.innerWidth - 48 - 24 - 100}px, ${window.innerHeight - 48 - 24 - 100}px, 0)`,
    );
