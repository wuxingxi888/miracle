...
function validateModelValue(
    ...
    if (accordion && Array.isArray(modelValue)) {
        console.error(
            '[Miracle] Collapse: "v-model" should not be Array in accordion mode',
        );
        return false;
    }
    if (!accordion && !Array.isArray(modelValue)) {
        console.error(
            '[Miracle] Collapse: "v-model" should be Array in non-accordion mode',
        );
        return false;
    }
    return true;
...
export default defineComponent({
    ...
    setup(props, { emit, slots }) {
        ...
        const toggleAll = (
            options: boolean | CollapseToggleAllOptions = {},
        ) => {
            if (props.accordion) {
                return;
            }
