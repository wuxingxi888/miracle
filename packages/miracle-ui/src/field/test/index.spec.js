...
test('should emit clickInput event when using input slot', () => {
  ...
  wrapper.find('.mi-field__control').trigger('click');
  expect(wrapper.emitted('clickInput')[0][0]).toBeTruthy();
});
...
test('should emit clickLeftIcon event when left icon is clicked', () => {
  ...
  wrapper.find('.mi-field__left-icon').trigger('click');
...
test('should emit clickRightIcon event when right icon is clicked', () => {
  ...
  wrapper.find('.mi-field__right-icon').trigger('click');
...
test('should show required icon when using rules which contain required', async () => {
  ...
  expect(wrapper.find('.mi-field__label--required').exists()).toBeFalsy();
  await wrapper.setProps({ rules: [{ required: true }] });
  expect(wrapper.find('.mi-field__label--required').exists()).toBeTruthy();
});
...
test('should autosize textarea field', async () => {
  ...
  const textarea = wrapper.find('.mi-field__control');
...
test('should limit maxlength of input value when using maxlength prop', async () => {
  ...
  // see: https://github.com/wuxingxi888/miracle/issues/7265
...
test('should render clear icon when using clearable prop', async () => {
  ...
  expect(wrapper.find('.mi-field__clear').exists()).toBeFalsy();
  const input = wrapper.find('input');
  await input.trigger('focus');
  expect(wrapper.find('.mi-field__clear').exists()).toBeTruthy();

  wrapper.find('.mi-field__clear').trigger('touchstart');
...
test('should render input slot correctly', () => {
  ...
  expect(wrapper.find('.mi-field__control').html()).toMatchSnapshot();
});
...
test('should render label slot correctly', () => {
  ...
  expect(wrapper.find('.mi-field__label').html()).toMatchSnapshot();
});
...
test('should change cell size when using size prop', () => {
  ...
  expect(wrapper.classes()).toContain('mi-cell--large');
});
...
test('should allow to set label width with unit', () => {
  ...
  const label = wrapper.find('.mi-field__label').element;
...
test('should render label class name when using label-class prop', () => {
  ...
  expect(wrapper.find('.mi-field__label').classes()).toContain('custom-class');
});
...
test('should change arrow direction when using arrow-direction prop', () => {
  ...
  expect(wrapper.find('.mi-icon-arrow-up').exists()).toBeTruthy();
});
...
test('should render word limit correctly', () => {
  ...
  expect(wrapper.find('.mi-field__word-limit').html()).toMatchSnapshot();
});
...
test('should change clear icon when using clear-icon prop', async () => {
  ...
  const input = wrapper.find('input');
  await input.trigger('focus');
  expect(wrapper.find('.mi-field__clear').html()).toMatchSnapshot();
});
...
test('should render error-message slot correctly', async () => {
  ...
  expect(wrapper.find('.mi-field__error-message').html()).toMatchSnapshot();
});
...
test('should render label correctly when dynamically set empty label', async () => {
  ...
  expect(wrapper.find('.mi-field__label').exists()).toBeFalsy();
});
...
test("should not be set label's for attribute when using input slot", async () => {
  ...
  expect(
    wrapper.find('.mi-field__label label').attributes('for'),
  ).toBeUndefined();
});
