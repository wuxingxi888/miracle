...
<template>
  ...
  <demo-block :title="t('horizontal')">
    <mi-checkbox-group v-model="state.horizontalResult" direction="horizontal">
      <mi-checkbox name="a">{{ t('checkbox') }} a</mi-checkbox>
      <mi-checkbox name="b">{{ t('checkbox') }} b</mi-checkbox>
    </mi-checkbox-group>
  </demo-block>
  ...
  <demo-block :title="t('title5')">
    <mi-checkbox-group v-model="state.result3">
      <mi-cell-group inset>
        ...
        >
          <template #right-icon>
            <mi-checkbox :ref="setRefs(index)" :name="item" @click.stop />
          </template>
        </mi-cell>
      </mi-cell-group>
    </mi-checkbox-group>
  ...
  <demo-block :title="t('indeterminate')">
    ...
    <div class="divider" />
    <mi-checkbox-group v-model="state.result4" @change="checkedResultChange">
