...
export default defineComponent({
    ...
    setup(props, { emit, slots }) {
        ...
        const getParentProp = <T extends keyof CheckerParent['props']>(
            name: T,
        ) => {
        ...
        const disabled = computed(() => {
            if (props.parent && props.bindGroup) {
                ...
                if (props.role === 'checkbox') {
                    const checkedCount = (
                        getParentProp('modelValue') as unknown[]
                    ).length;
        ...
        const iconStyle = computed(() => {
            const checkedColor =
                props.checkedColor || getParentProp('checkedColor');
        ...
        const onClick = (event: MouseEvent) => {
            ...
            const iconClicked =
                icon === target || icon?.contains(target as Node);
                ...
                >
                    {slots.icon ? (
                        ...
                        <div
                            ...
                            style={{
                                backgroundColor:
                                    iconStyle.value?.backgroundColor,
                            }}
                        ></div>
                    )}
                </div>
