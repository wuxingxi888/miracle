        ...
        const wrapper = mount(Uploader, {
            props: {
                ...
                afterRead: (
                    ...
                    expect(
                        (readFile as UploaderFileListItem).file,
                    ).toBeTruthy();
                    expect(
                        (readFile as UploaderFileListItem).content,
                    ).toBeFalsy();
                    resolve();
                },
            },
...
test('should render preview-cover slot correctly', async () => {
    ...
    expect(
        wrapper.find('.mi-uploader__preview-cover').html(),
    ).toMatchSnapshot();
});
...
test('should render preview-delete slot correctly', async () => {
    ...
    expect(
        wrapper.find('.mi-uploader__preview-delete').html(),
    ).toMatchSnapshot();
});
