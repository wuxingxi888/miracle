...
| 名称 | 默认值 | 描述 |
| --- | --- | --- |
| --mi-uploader-size | _80px_ | - |
| --mi-uploader-icon-size | _24px_ | - |
| --mi-uploader-icon-color | _var(--mi-gray-4)_ | - |
| --mi-uploader-text-color | _var(--mi-text-color-2)_ | - |
| --mi-uploader-text-font-size | _var(--mi-font-size-sm)_ | - |
| --mi-uploader-upload-background | _var(--mi-gray-1)_ | - |
| --mi-uploader-upload-active-color | _var(--mi-active-color)_ | - |
| --mi-uploader-delete-color | _var(--mi-white)_ | - |
| --mi-uploader-delete-icon-size | _14px_ | - |
| --mi-uploader-delete-background | _rgba(0, 0, 0, 0.7)_ | - |
| --mi-uploader-file-background | _var(--mi-background)_ | - |
| --mi-uploader-file-icon-size | _20px_ | - |
| --mi-uploader-file-icon-color | _var(--mi-gray-7)_ | - |
| --mi-uploader-file-name-padding | _0 var(--mi-padding-base)_ | - |
| --mi-uploader-file-name-margin-top | _var(--mi-padding-xs)_ | - |
| --mi-uploader-file-name-font-size | _var(--mi-font-size-sm)_ | - |
| --mi-uploader-file-name-text-color | _var(--mi-gray-7)_ | - |
| --mi-uploader-mask-text-color | _var(--mi-white)_ | - |
| --mi-uploader-mask-background | _fade(var(--mi-gray-8), 88%)_ | - |
| --mi-uploader-mask-icon-size | _22px_ | - |
| --mi-uploader-mask-message-font-size | _var(--mi-font-size-sm)_ | - |
| --mi-uploader-mask-message-line-height | _var(--mi-line-height-xs)_ | - |
| --mi-uploader-loading-icon-size | _22px_ | - |
| --mi-uploader-loading-icon-color | _var(--mi-white)_ | - |
| --mi-uploader-disabled-opacity | _var(--mi-disabled-opacity)_ | - |
| --mi-uploader-border-radius | _0px_ | - |
