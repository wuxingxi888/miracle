...
const disabledClass = 'mi-checkbox--disabled';
...
test('should emit "update:modelValue" event when checkbox is clicked', async () => {
  ...
  const items = wrapper.findAll('.mi-checkbox');
...
test('should change icon size when using icon-size prop', () => {
  ...
  const icons = wrapper.findAll('.mi-checkbox__icon');
...
test('should change checked color when using checked-color prop', () => {
  ...
  const icons = wrapper.findAll('.mi-icon');
...
test('should render shape correctly when using shape prop', () => {
  ...
  const shapeClass = 'mi-checkbox__icon--square';
  const shapeClass1 = 'mi-checkbox__icon--round';
  const iconBoxs = wrapper.findAll('.mi-checkbox__icon');
