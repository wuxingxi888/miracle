...
test('should allow to intercept closing action with before-close prop', async () => {
    ...
    const confirm = wrapper.find('.mi-dialog__confirm');
    confirm.trigger('click');
    expect(wrapper.emitted('update:show')).toBeFalsy();

    const cancel = wrapper.find('.mi-dialog__cancel');
...
test('should change confirm button color when using confirm-button-color prop', () => {
    ...
    const confirmButton = wrapper.find('.mi-dialog__confirm');
...
test('should change cancel button color when using cancel-button-color prop', () => {
    ...
    const cancelButton = wrapper.find('.mi-dialog__cancel');
...
test('should render button text correctly', () => {
    ...
    expect(wrapper.find('.mi-dialog__footer').html()).toMatchSnapshot();
});
...
test('should render default slot correctly', () => {
    ...
    expect(wrapper.find('.mi-dialog__content').html()).toMatchSnapshot();
});
...
test('should render title slot correctly', () => {
    ...
    expect(wrapper.find('.mi-dialog__header').html()).toMatchSnapshot();
});
...
test('should update width when using width prop', async () => {
    ...
    const dialog = wrapper.find('.mi-dialog').element;
...
test('should render footer slot correctly', () => {
    ...
    expect(wrapper.find('.mi-dialog').html()).toMatchSnapshot();
});
...
test('should allow to disable confirm button', () => {
    ...
    expect(wrapper.find('.mi-dialog__confirm').classes()).toContain(
        'mi-button--disabled',
    );
});
...
test('should allow to disable cancel button', () => {
    ...
    expect(wrapper.find('.mi-dialog__cancel').classes()).toContain(
        'mi-button--disabled',
    );
});
