...
为了便于使用 `Dialog`，Miracle 提供了一系列辅助函数，通过辅助函数可以快速唤起全局的弹窗组件。
...
| 名称 | 默认值 | 描述 |
| --- | --- | --- |
| --mi-dialog-width | _320px_ | - |
| --mi-dialog-small-screen-width | _90%_ | - |
| --mi-dialog-font-size | _var(--mi-font-size-lg)_ | - |
| --mi-dialog-transition | _var(--mi-duration-base)_ | - |
| --mi-dialog-radius | _16px_ | - |
| --mi-dialog-background | _var(--mi-background-2)_ | - |
| --mi-dialog-header-font-weight | _var(--mi-font-bold)_ | - |
| --mi-dialog-header-line-height | _24px_ | - |
| --mi-dialog-header-padding-top | _26px_ | - |
| --mi-dialog-header-isolated-padding | _var(--mi-padding-lg) 0_ | - |
| --mi-dialog-message-padding | _var(--mi-padding-lg)_ | - |
| --mi-dialog-message-font-size | _var(--mi-font-size-md)_ | - |
| --mi-dialog-message-line-height | _var(--mi-line-height-md)_ | - |
| --mi-dialog-message-max-height | _60vh_ | - |
| --mi-dialog-has-title-message-text-color | _var(--mi-gray-7)_ | - |
| --mi-dialog-has-title-message-padding-top | _var(--mi-padding-xs)_ | - |
| --mi-dialog-button-height | _48px_ | - |
| --mi-dialog-round-button-height | _36px_ | - |
| --mi-dialog-confirm-button-text-color | _var(--mi-primary-color)_ | - |
...
* miracle/es/show-dialog in ./src/xxx.js
* miracle/es/show-dialog/style in ./src/xxx.js
```

Miracle 不支持 `babel-plugin-import` 插件，请参考 [迁移指南](#/zh-CN/migrate-from-v3#yi-chu-babel-plugin-import) 移除该插件。
