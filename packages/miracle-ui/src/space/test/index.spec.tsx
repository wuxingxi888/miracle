...
test('should render space', async () => {
    ...
    const items = wrapper.findAll('.mi-space-item');
...
test('should render vertical', async () => {
    ...
    const space = wrapper.find('.mi-space');
    const items = wrapper.findAll('.mi-space-item');
    expect(space.classes()).toContain('mi-space--vertical');
...
test('should render align start', async () => {
    ...
    const space = wrapper.find('.mi-space');
    expect(space.classes()).toContain('mi-space--align-start');
});
...
test('should render wrap', async () => {
    ...
    const space = wrapper.find('.mi-space');
    expect(space.classes()).toContain('mi-space--wrap');
});
