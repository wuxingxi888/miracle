...
test('should auto play when only list props', async () => {
    ...
    expect(wrapper.findAll('.mi-barrage__item')).toHaveLength(7);
});
...
test('should not auto play use play function when use play function', async () => {
    ...
    expect(
        (wrapper.find('.mi-barrage__item') as HTMLSpanElement).style
            .animationPlayState,
    ).toBe('paused');
...
test('should emit "update:modelValue" when animationend', async () => {
    ...
    expect(wrapper.findAll('.mi-barrage__item')).toHaveLength(8);

    await trigger(
        wrapper.find('.mi-barrage__item') as HTMLSpanElement,
        'animationend',
    );
