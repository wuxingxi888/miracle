    ...
    setup(props, { slots }) {
        ...
        if (!parent) {
            if (process.env.NODE_ENV !== 'production') {
                console.error(
                    '[Miracle] <CollapseItem> must be a child component of <Collapse>.',
                );
            }
            return;
        }
        ...
        watch(expanded, (value, oldValue) => {
            ...
            tick(() => {
                ...
                if (offsetHeight) {
                    ...
                    doubleRaf(() => {
                        if (wrapperRef.value) {
                            wrapperRef.value.style.height = value
                                ? contentHeight
                                : '0';
                        }
                    });
        ...
        const renderTitle = () => {
            ...
            const attrs = pick(
                props,
                Object.keys(cellSharedProps) as Array<
                    keyof typeof cellSharedProps
                >,
            );
