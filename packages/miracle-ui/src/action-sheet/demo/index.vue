...
import MiActionSheet, { ActionSheetAction } from '..';
...
<template>
  <demo-block card :title="t('basicUsage')">
    <mi-cell is-link :title="t('basicUsage')" @click="showBasic = true" />
    <mi-cell is-link :title="t('showIcon')" @click="showIcon = true" />
    <mi-cell is-link :title="t('showCancel')" @click="showCancel = true" />
    <mi-cell
      is-link
  ...
  <demo-block card :title="t('optionStatus')">
    <mi-cell is-link :title="t('optionStatus')" @click="showStatus = true" />
  </demo-block>

  <demo-block card :title="t('customPanel')">
    <mi-cell is-link :title="t('customPanel')" @click="showTitle = true" />
  </demo-block>
  ...
  <mi-action-sheet v-model:show="showTitle" :title="t('title')">
...
.demo-action-sheet {
  &-content {
    padding: var(--mi-padding-md) var(--mi-padding-md)
      calc(var(--mi-padding-md) * 10);
  }
}
</style>
