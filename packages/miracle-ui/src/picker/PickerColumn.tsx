...
export default defineComponent({
    ...
    props: {
        value: numericProp,
        fields: makeRequiredProp(
            Object as PropType<Required<PickerFieldNames>>,
        ),
    ...
    setup(props, { emit, slots }) {
        ...
        const updateValueByIndex = (index: number) => {
            ...
            const trigger = () => {
                if (enabledIndex > count() - 1) {
                    enabledIndex = findIndexOfEnabledOption(
                        props.options,
                        index,
                    );
                }
        ...
        const currentIndex = computed(() =>
            getIndexByOffset(currentOffset.value),
        );
        ...
        const onTouchEnd = () => {
            ...
            const startMomentum =
                duration < MOMENTUM_TIME &&
                Math.abs(distance) > MOMENTUM_DISTANCE;
            ...
            >
                <ul
                    ...
                    style={{
                        ...
                        transitionProperty: currentDuration.value
                            ? 'all'
                            : 'none',
                    }}
                    class={bem('wrapper')}
