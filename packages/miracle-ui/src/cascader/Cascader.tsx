...
export default defineComponent({
    ...
    setup(props, { slots, emit }) {
        ...
        const renderOption = (
            ...
            const color =
                option.color || (selected ? props.activeColor : undefined);
            ...
            return (
                <li
                    ref={
                        selected ? setSelectedElementRefs(tabIndex) : undefined
                    }
                    role="menuitemradio"
                    class={[
                        bem('option', { selected, disabled }),
                        option.className,
                    ]}
                    style={{ color }}
        ...
        const scrollIntoView = (el: HTMLElement) => {
            ...
            if (scrollParent) {
                scrollParent.scrollTop =
                    el.offsetTop -
                    (scrollParent.offsetHeight - el.offsetHeight) / 2;
            }
        };
        ...
        watch(
            ...
            (value) => {
                if (value !== undefined) {
                    const values = tabs.value.map(
                        (tab) => tab.selected?.[valueKey],
                    );
