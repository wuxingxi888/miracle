...
test('should render the specified text label highlighting correctly', () => {
    ...
    const highlight = wrapper.find('.mi-highlight');
    const tagText = highlight.find('.mi-highlight__tag').text();
...
test('multiple keywords highlighting can be specified', () => {
    ...
    const highlight = wrapper.find('.mi-highlight');
    const tags = highlight.findAll('.mi-highlight__tag');
...
test('should set custom class of the highlight tag', () => {
    ...
    const highlight = wrapper.find('.mi-highlight');
    const tag = highlight.find('.mi-highlight__tag');
