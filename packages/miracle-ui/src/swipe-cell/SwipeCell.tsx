...
// Composables
import { useRect, useClickAway, useEventListener } from '@miracle-web/use';
...
export default defineComponent({
    ...
    setup(props, { emit, slots }) {
        ...
        const open = (side: SwipeCellSide) => {
            state.offset =
                side === 'left' ? leftWidth.value : -rightWidth.value;
        ...
        const getClickHandler =
            (position: SwipeCellPosition, stop?: boolean) =>
            (event: MouseEvent) => {
                if (stop) {
