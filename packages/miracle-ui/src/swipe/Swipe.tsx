    ...
    setup(props, { emit, slots }) {
        ...
        const trackStyle = computed(() => {
            ...
            if (size.value) {
                ...
                style[crossAxis] = props[crossAxis]
                    ? `${props[crossAxis]}px`
                    : '';
            }
        ...
        const initialize = (active = +props.initialSwipe) => {
            ...
            // issue: https://github.com/wuxingxi888/miracle/issues/10052
            if (isHidden(root)) {
                nextTick().then(cb);
            } else {
                cb();
        ...
        const onTouchEnd = () => {
            ...
            const shouldSwipe =
                Math.abs(speed) > 0.25 ||
                Math.abs(delta.value) > size.value / 2;
        ...
        const renderIndicator = () => {
            ...
            if (props.showIndicators && count.value > 1) {
                return (
                    <div
                        class={bem('indicators', { vertical: props.vertical })}
                    >
