...
- vant.config.js 重命名为 `miracle.config.mjs`，由 CommonJS 变更为 ESModule 格式
...
- build 命令支持生成 WebStorm 组件定义文件 ([#5899](https://github.com/wuxingxi888/miracle/issues/5899))
- clean 命令现在会移除而不是清空文件夹 ([#5895](https://github.com/wuxingxi888/miracle/issues/5895))
...
- 升级 @miracle/eslint-config@2.0.0
