    ...
    <div class="mi-doc-row">
      <div class="mi-doc-header__top">
        <a class="mi-doc-header__logo">
          ...
          <span v-if="config.subtitle" class="mi-doc-header__subtitle">
            {{ config.subtitle }}
          </span>
        </a>
        ...
        <ul class="mi-doc-header__top-nav">
          ...
          >
            <a class="mi-doc-header__link" target="_blank" :href="item.url">
          ...
          <li v-if="darkModeClass" class="mi-doc-header__top-nav-item">
            <a class="mi-doc-header__link" target="_blank" @click="toggleTheme">
              <img :src="themeImg" />
            </a>
          </li>

          <li ref="version" v-if="versions" class="mi-doc-header__top-nav-item">
            <span
            ...
            >
              ...
              <transition name="mi-doc-dropdown">
                <div v-if="showVersionPop" class="mi-doc-header__version-pop">
                  <div
